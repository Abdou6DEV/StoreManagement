        ...
        <body>
          <div class="receipt">
            ...
            <div class="totals">
              <div class="total-row">
                <span>Subtotal:</span>
                <span>${total.toLocaleString()} ${t?.("cashier.currency", "DA") || "DA"}</span>
              </div>
              ${
                discount > 0
                  ? `
                <div class="total-row">
                  <span>Discount:</span>
                  <span>-${discount.toLocaleString()} ${t?.("cashier.currency", "DA") || "DA"}</span>
                </div>
              `
                  : ""
              }
              ${
                ...
                <div class="total-row">
                  <span>New Total:</span>
                  <span>${finalTotal.toLocaleString()} ${t?.("cashier.currency", "DA") || "DA"}</span>
                </div>
              `
                  : ""
              }
            ...
            ${
              ...
              <div class="payment-info">
                ...
                <div>Amount Paid: ${paymentAmount.toLocaleString()} ${t?.("cashier.currency", "DA") || "DA"}</div>
                <div>Due Date: ${paymentDate ? paymentDate.toLocaleDateString() : "N/A"}</div>
                <div>Remaining: ${(finalTotal - paymentAmount).toLocaleString()} ${t?.("cashier.currency", "DA") || "DA"}</div>
              </div>
            `
                : ""
            }
