...
const FavoritesBrowser: React.FC<FavoritesBrowserProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener("favorites-updated", handleCustomStorageChange);
    };
  }, []);
           ...
           <div>
             <div className="text-xs font-medium text-muted-foreground mb-2">
               ...
               {frequentlyUsedProducts.map((product) => (
                 ...
                 {/* Empty State */}
         {favoriteProducts.length === 0 && frequentlyUsedProducts.length === 0 && (
           <div className="text-center py-4 text-muted-foreground">
             ...
             <div className="text-xs">
               {t("cashier.addFavoritesHint", "Click the star icon on products to add them to favorites")}
             </div>
           </div>
         )}
      </div>
