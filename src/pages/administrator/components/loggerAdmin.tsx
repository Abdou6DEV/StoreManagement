          ...
          <div className="space-y-4 p-4 border rounded-lg">
            <div>
              ...
              <Select
                ...
                onValueChange={(value: string) =>
                  updateConfig({ level: value as LogLevel })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateConfig({ maxFiles: parseInt(e.target.value) })
                }
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) =>
                  updateConfig({ logToConsole: e.target.checked })
                }
              />
          ...
          <div className="space-y-3 p-3 border rounded-lg bg-gray-50">
            ...
            <div className="flex gap-2">
              ...
              <Select
                ...
                onValueChange={(value: string) =>
                  setSelectedProcess(value as "main" | "renderer" | "ALL")
                }
              >
                <SelectTrigger className="w-24">
                  <SelectValue />
            ...
            <div className="text-xs text-gray-600">
              Showing {filteredAndPaginatedEntries.entries.length} of{" "}
              {filteredAndPaginatedEntries.totalEntries} entries
              {fileStats && (
                <div className="mt-1">
