...
const ClientsTable: React.FC<ClientsTableProps> = ({
  ...
  const showInitialTableLoader = loading && clients.length === 0;
  const showTableRefreshOverlay = loading && clients.length > 0;
  ...
  return (
    ...
    >
      ...
      {showTableRefreshOverlay ? (
        ...
        >
          <div
            className="size-10 shrink-0 rounded-full border-[3px] border-red-500/20 border-t-red-500 animate-spin motion-reduce:animate-none"
            aria-hidden
          />
        </div>
      ) : null}
      ...
      >
        ...
        <tbody className="divide-y divide-border">
          {!showInitialTableLoader && clients.length === 0 ? (
            <tr>
              <td
                colSpan={8}
