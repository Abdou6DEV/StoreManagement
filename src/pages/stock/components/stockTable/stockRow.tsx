...
export const StockRow = React.memo(function StockRow({
  ...
  return (
    <tr key={product.id} className="h-[48px] hover:bg-muted/40 transition">
      ...
      <td className="px-4">{product.boughtPrice} {t("cashier.currency", "DA")}</td>
      <td className="px-4">{product.sellingPrice} {t("cashier.currency", "DA")}</td>
      <td className="px-4 text-green-700 font-medium">{profit} {t("cashier.currency", "DA")}</td>
      <td className="px-4">{product.totalSold ?? 0}</td>
      <td className="px-4 text-green-700 font-medium">{totalProfit} {t("cashier.currency", "DA")}</td>
      <td className="px-4">
